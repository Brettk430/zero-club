  ...
  return (
    <>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-6 text-center shadow-sm sm:p-10 dark:border-slate-700 dark:bg-slate-900">
        ...
        <p className="mt-3 text-slate-500 dark:text-slate-400">First 100 members get Pro completely free. You're early.</p>
        ...
        <div className="mt-8 inline-block rounded-3xl border border-slate-200 bg-slate-50 px-8 py-6 text-left dark:border-slate-700 dark:bg-slate-800">
          <p className="text-sm font-semibold uppercase tracking-widest text-blue-600 dark:text-blue-400">Pro — free for founders</p>
      ...
      <div className="mx-auto max-w-sm text-center">
        ...
        {sent ? (
          ...
          <>
            ...
            <p className="mt-3 text-slate-500 dark:text-slate-400">
              First 100 members get Pro free. Enter your email to get started — no password needed.
            </p>
